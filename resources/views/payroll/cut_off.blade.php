                ...
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row align-items-center">
							<div class="col">
								<h3 class="page-title">Cut-Off</h3>
								<ul class="breadcrumb">
					...
					<div class="row">
						<div class="col-md-12">
							<div class="table-responsive">
								<table class="table dataTable display nowrap cell-border" id="getCutOffList" width="100%" cellspacing="0">
											<thead>
												<tr>
													<th class="all">#</th>
													<th class="all">Branch</th>
													<th class="all">Period Start</th>
													<th class="all">Period End</th>
													<th class="all">Gross Salary</th>
													<th class="all">Net Salary</th>
													<th class="none">Prepared By:</th>
													<th class="none">Reviewed By:</th>
