   ...
   <script type="text/javascript">
	...
	$(function () {
				var EmployeeList = $('#EmployeeRegularLogsListDatatable').DataTable({
					...
					columns: [
							...
							{data: 'total_regular_hours', className: "text-left", searchable: false},
							{data: 'total_night_differential_hours', className: "text-left", searchable: false},
							{data: 'branch_name', className: "text-left"},
							{data: 'department_name', className: "text-left"},
							{data: 'log_in', className: "text-left", searchable: false},
							{data: 'log_out', className: "text-left", searchable: false},
							{data: 'breaktime_start', className: "text-left", searchable: false},
							{data: 'breaktime_end', className: "text-left", searchable: false},
							{data: 'regular_pay', className: "text-left", searchable: false},
							{data: 'night_differential_pay', className: "text-left", searchable: false},
							{data: 'regular_holiday_pay', className: "text-left", searchable: false},
							{data: 'special_holiday_pay', className: "text-left", searchable: false},
	...
	$(function () {
				var EmployeeList = $('#EmployeeRegularOTLogsListDatatable').DataTable({
					...
					//scrollY: '500px',
					//scrollX: '100%',
					ajax: "{{ route('getEmployeeOvertimeLogsList') }}",
					columns: [
							{data: 'DT_RowIndex', name: 'DT_RowIndex' , orderable: false, searchable: false, className: "text-right"}, 	
							{data: 'attendance_date', className: "text-left"},
							...
							{data: 'employee_number', className: "text-left"},
							{data: 'employee_full_name', className: "text-left"},
							{data: 'total_overtime_hours', className: "text-left"},
	...
	$(function () {
				var EmployeeList = $('#EmployeeRestDayOTLogsListDatatable').DataTable({
					...
					//scrollY: '500px',
					//scrollX: '100%',
					ajax: "{{ route('getEmployeeRestDayLogsList') }}",
					columns: [
							{data: 'DT_RowIndex', name: 'DT_RowIndex' , orderable: false, searchable: false, className: "text-right"}, 	
							{data: 'attendance_date', className: "text-left"},
							{data: 'employee_number', className: "text-left"},
							{data: 'employee_full_name', className: "text-left"},
							{data: 'total_restday_hours', className: "text-left"},
							{data: 'total_night_differential_hours', className: "text-left"},
							{data: 'branch_name', className: "text-left"},
							{data: 'department_name', className: "text-left"},
							{data: 'log_in', className: "text-left"},
							...
							{data: 'breaktime_start', className: "text-left"},
							{data: 'breaktime_end', className: "text-left"},
							{data: 'restday_pay', className: "text-left"},
							{data: 'night_differential_pay', className: "text-left"},
							{data: 'regular_holiday_pay', className: "text-left"},
							{data: 'special_holiday_pay', className: "text-left"},
							{data: 'action', name: 'action', orderable: false, searchable: false, className: "text-center"},
